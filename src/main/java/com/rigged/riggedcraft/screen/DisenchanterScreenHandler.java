...
public class DisenchanterScreenHandler extends ScreenHandler {
    ...
    public DisenchanterScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory, PropertyDelegate delegate) {
        super(ModScreenHandlers.DISENCHANTER_SCREEN_HANDLER, syncId);
