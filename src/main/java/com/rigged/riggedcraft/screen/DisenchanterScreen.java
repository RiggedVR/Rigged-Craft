...
public class DisenchanterScreen extends HandledScreen<DisenchanterScreenHandler> {
    ...
    private static final Identifier TEXTURE = new Identifier(RiggedCraftMod.MOD_ID, "textures/gui/disenchanter_gui.png");
    ...
    private void renderProgressArrow(MatrixStack matrices, int x, int y) {
        if(handler.isCrafting()) {
            drawTexture(matrices, x + 103, y + 30, 176, 0, 8, handler.getScaledProgress());
        }
    }
