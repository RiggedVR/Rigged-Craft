...
import com.rigged.riggedcraft.block.entity.DisenchanterBlockEntity;
...
public class DisenchanterBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if(state.getBlock() != newState.getBlock()){
            ...
            if(blockEntity instanceof DisenchanterBlockEntity){
                ItemScatterer.spawn(world, pos, (DisenchanterBlockEntity)blockEntity);
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, ModBlockEntities.DISENCHANTER, DisenchanterBlockEntity::tick);
    }
}
